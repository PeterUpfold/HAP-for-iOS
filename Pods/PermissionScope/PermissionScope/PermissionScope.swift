...
@objc public class PermissionScope: UIViewController, CLLocationManagerDelegate, UIGestureRecognizerDelegate, CBPeripheralManagerDelegate {
    ...
    @objc lazy var bluetoothManager:CBPeripheralManager = {
        return CBPeripheralManager(delegate: self, queue: nil, options:[CBPeripheralManagerOptionShowPowerAlertKey: false])
    }()
    
    @objc lazy var motionManager:CMMotionActivityManager = {
        return CMMotionActivityManager()
    }()
    
    /// NSUserDefaults standardDefaults lazy var
    @objc lazy var defaults:UserDefaults = {
        return .standard
    }()
    
    /// Default status for Core Motion Activity
    @objc var motionPermissionStatus: PermissionStatus = .unknown

    // MARK: - Internal state and resolution
    
    /// Permissions configured using `addPermission(:)`
    @objc var configuredPermissions: [Permission] = []
    @objc var permissionButtons: [UIButton]       = []
    @objc var permissionLabels: [UILabel]         = []
    ...
    */
    @objc func allAuthorized(_ completion: @escaping (Bool) -> Void ) {
    ...
    **Deprecated** See issues #50 and #51.
    ...
    - parameter completion: Closure used to send the result of the check.
    */
    @objc func requiredAuthorized(_ completion: @escaping (Bool) -> Void ) {
        getResultsForConfig{ results in
            let result = results
                .first { $0.status != .authorized }
                .isNil
    ...
    */
    @objc func permissionStyledButton(_ type: PermissionType) -> UIButton {
    ...
    */
    @objc func setButtonAuthorizedStyle(_ button: UIButton) {
    ...
    - parameter button: Permission button
    */
    @objc func setButtonUnauthorizedStyle(_ button: UIButton) {
        button.layer.borderWidth = 0
    ...
    */
    @objc func permissionStyledLabel(_ type: PermissionType) -> UILabel {
    ...
    */
    @objc var notificationTimer : Timer?
    ...
    */
    @objc func showDeniedAlert(_ permission: PermissionType) {
    ...
    - parameter permission: Permission type.
    */
    @objc func showDisabledAlert(_ permission: PermissionType) {
        // compile the results and pass them back if necessary
        if let onDisabledOrDenied = self.onDisabledOrDenied {
            self.getResultsForConfig({ results in
                onDisabledOrDenied(results)
    ...
    */
    @objc func statusForPermission(_ type: PermissionType, completion: statusRequestClosure) {
    ...
    */
    @objc func getResultsForConfig(_ completionBlock: resultsForConfigClosure) {
